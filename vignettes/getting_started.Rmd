...
See the CloudML website for documentation on [available machine types](https://cloud.google.com/vertex-aidocs/training-overview#machine_type_table). Also note that GPU instances can be considerably more expensive that CPU ones! See the documentation on [CloudML Pricing](https://cloud.google.com/vertex-aipricing) for details.
