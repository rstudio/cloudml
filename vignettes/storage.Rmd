...
Note that the `data_dir` R variable is computed by passing `FLAGS$data_dir` to the `gs_local_dir()` function. This enables it to take on a dynamic value depending upon the training environment.
