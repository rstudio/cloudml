...
data <- read.table(
  cloudml::gutil_data("gs://rstudio-cloudml-demo-ml/census/data/local.adult.test"),
...
filename <- cloudml::gutil_data("gs://rstudio-cloudml-demo-ml/census/data/local.adult.test")
