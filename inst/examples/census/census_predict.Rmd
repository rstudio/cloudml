...
output$conf <- renderTable(rownames = TRUE, digits = 0, {
  ...
  conf_matrix[1,1] <- sum(labelled_data()$Label == " <=50K." & labelled_data()$income_bracket == " <=50K." )
  conf_matrix[1,2] <- sum(labelled_data()$Label == " >50K." & labelled_data()$income_bracket == " <=50K." )
  conf_matrix[2,1] <- sum(labelled_data()$Label == " <=50K." & labelled_data()$income_bracket == " >50K." )
  conf_matrix[2,2] <- sum(labelled_data()$Label == " >50K." & labelled_data()$income_bracket == " >50K." )
